...
def show_res():
    without_func_time, with_func_time, numbers = compare_perfomance(int(entry.get()))
    res = [0] * 3
    ...
    listbox = Listbox(listvariable = StringVar(value = res))
...
btn = ttk.Button(root, text="Click", command=show_res)
btn.pack()
